        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReceiveNotification = table.Column<bool>(type: "boolean", nullable: false),
                    IsRoot = table.Column<bool>(type: "boolean", nullable: false),
                    UserStatusId = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Devices", x => new { x.UserId, x.DeviceType });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_UserId_DeviceType",
                table: "Devices",
